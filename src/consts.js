...
export const VERSION_FILTER = {
  ...
  SEMVER_NON_RELEASES: {
    id: 'semver_non_releases',
    name: 'Build/PreReleases',
  },
  SEMVER_RELEASES: {
    id: 'semver_releases',
    name: 'Releases',
...
export const SCANNERS_FOR_WRITEBACK_TYPE = {
  [SCANNER_WRITEBACK_TYPES.LICENSE]: [
    COMPLIANCE_TOOLS.BLACKDUCK,
  ],
  [SCANNER_WRITEBACK_TYPES.PACKAGE_VERSION]: [
    COMPLIANCE_TOOLS.BDBA,
    COMPLIANCE_TOOLS.BLACKDUCK,
  ],
}
